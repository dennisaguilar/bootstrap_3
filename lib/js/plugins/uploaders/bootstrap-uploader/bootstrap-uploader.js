...
(function (factory) {
    ...
    $.fn.fileinputLocales.en = {
        ...
        cancelTitle: 'Cancelar o upload em andamento',
        ...
        msgSizeTooLarge: 'Arquivo "{name}" (<b>{size} KB</b>) excede o tamanho máximo de upload permitido <b>{maxSize} KB</b>.',
        msgFilesTooLess: 'Você deve selecionar pelo menos um <b>{n}</b> {files} para upload.',
        msgFilesTooMany: 'Número de arquivos selecionados para upload <b>({n})</b> excede o limite máximo permitido <b>{m}</b>.',
        ...
        msgFilePreviewAborted: 'Visualização de arquivo anulada "{name}".',
        msgFilePreviewError: 'Ocorreu um erro durante a leitura do arquivo "{name}".',
        msgInvalidFileType: 'Tipo inválido de arquivo "{name}". Somente arquivos "{types}" são suportados.',
        ...
        msgLoading: 'Carregando arquivo {index} de {files};',
        msgProgress: 'Carregando arquivo {index} de {files} - {name} - {percent}% completo.',
        msgSelected: '{n} {files} Seleionado',
        msgFoldersNotAllowed: 'Arrastar e soltar apenas arquivos! {n} pasta(s) são ignorados.',
        ...
        previewZoomButtonTitles: {
            ...
            next: 'Visualizar o próximo arquivo',
